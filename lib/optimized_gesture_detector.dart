...
class OptimizedGestureDetector extends StatelessWidget {
  ...
  late bool? _isRealScale;
  bool _isMoveCancel = false;
  bool _isScaleCancel = false;

  late Timer? _singleTapTimer = null;

  late Direction? _scaleMainDirection;

  late Offset? _lastMoveUpdateGolbalPos;
  late Offset? _lastMoveUpdateLocalPos;

  late Offset? _lastScaleUpdateGolbalPos;
  late Offset? _lastScaleUpdateLocalPos;
